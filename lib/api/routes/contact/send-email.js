...
async function handler(req, res) {
  ...
  // Honeypot: hidden field that only bots fill in. Pretend success so we
  // give automated submitters no signal, but never send the email.
...
<div class='footer'>&copy; ${year} Enprico - French for TEF & TCF Exams<br><a href='https://enprico.ca' style='color: #0076c7;'>www.enprico.ca</a></div>
</div></body></html>`;
  } else {
