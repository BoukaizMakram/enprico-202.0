...
import { createSupabaseUser, createUserProfile, getPendingRegistration, markRegistrationCompleted, generateUserPassword, getUserByEmail, createSubscriptionIfNeeded } from '@/lib/api/auth.js';
import { sendEmail, welcomeEmailHtml, adminNotificationHtml, hoursAddedEmailHtml, getPlanName } from '@/lib/api/email.js';
